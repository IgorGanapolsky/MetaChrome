...
async function main() {
    ...
    // Transforms
    const transforms = [
        new SentenceSplitterTransform(),
        new ChunkingTransform(250, 0.15)
    ];
    ...
    if (dryRun) {
        ...
        const dataStore = 'projects/metachrome-2025/locations/us/collections/default_collection/dataStores/rag-documents_1766504544296/branches/default_branch/documents';
